...
final class MainViewController: UIViewController {
    ...
    private func createMediaTypesSection() -> NSCollectionLayoutSection {
        ...
        layoutGroup.contentInsets = NSDirectionalEdgeInsets(top: 20, leading: 10, bottom: 0, trailing: 10)
        ...
        let layoutSection = NSCollectionLayoutSection(group: layoutGroup)
        layoutSection.contentInsets = NSDirectionalEdgeInsets(top: 30, leading: 10, bottom: 30, trailing: 10)
